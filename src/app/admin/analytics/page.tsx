    ...
    <main className="mx-auto w-full max-w-5xl flex-grow px-4 pb-8 pt-6 sm:px-6">
      ...
      <div className="mt-6">
        ...
        <p className="mt-3 max-w-2xl text-sm leading-6 text-[var(--text-muted)]">
          Analytics data and generated reports stay in the private operations
          repository. Use the links below to inspect the current sources.
        </p>
      </div>
      ...
      <section className="mt-8 grid gap-4 md:grid-cols-2">
        ...
        >
          ...
          <p className="mt-2 text-sm leading-6 text-[var(--text-muted)]">
            Review live traffic, security events, and Worker activity.
          </p>
        </a>
        <a
        ...
        >
          ...
          <p className="mt-2 text-sm leading-6 text-[var(--text-muted)]">
            Open the local read-only dashboard generated by the private
            workspace.
          </p>
        </a>
      </section>
