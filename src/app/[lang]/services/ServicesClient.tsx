                ...
                {[
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="mt-1 truncate text-[10px] font-semibold uppercase tracking-[0.18em] text-[var(--text-faint)]">
                        {item.label}
                      </div>
                    </div>
                  );
    ...
    return (
      ...
      >
        <div className="flex items-start justify-between gap-2">
          ...
          {external && (
            <ExternalLink className="h-3.5 w-3.5 text-[var(--text-faint)] transition group-hover:text-[var(--accent-color)]" />
          )}
        </div>
        <div>
    ...
    >
      <div className="flex items-start justify-between gap-4">
        <div className="flex min-w-0 items-start gap-3">
          <div
            className={`flex shrink-0 items-center justify-center rounded-2xl border border-[var(--border-subtle)] bg-[var(--bg-tertiary)] text-[var(--text-secondary)] transition group-hover:border-emerald-500/20 group-hover:bg-emerald-500/8 group-hover:text-[var(--accent-color)] ${featured ? "h-12 w-12" : "h-11 w-11"}`}
          >
        ...
        {external && (
          <ExternalLink className="h-4 w-4 shrink-0 text-[var(--text-faint)] transition group-hover:text-[var(--accent-color)]" />
        )}
      </div>
      ...
      <div className="mt-5 flex items-center justify-between gap-3">
        <div className="flex flex-wrap gap-1.5">
          {tool.tags.slice(0, 3).map((tag) => (
            <span
              key={tag}
              className="rounded-full border border-[var(--border-subtle)] bg-[var(--bg-tertiary)] px-2 py-1 text-[10px] font-semibold uppercase tracking-[0.14em] text-[var(--text-muted)]"
            >
              {tag}
            </span>
          ))}
        ...
        <span
          className={`inline-flex shrink-0 items-center rounded-full border px-2.5 py-1 text-[10px] font-bold uppercase tracking-[0.14em] ${
            builtIn
...
function DailyLauncherLink({ tool }: { tool: Tool }) {
  ...
  return (
    ...
    >
      ...
      {external && (
        <ExternalLink className="h-3.5 w-3.5 shrink-0 text-[var(--text-faint)] transition group-hover:text-[var(--accent-color)]" />
      )}
    </Link>
  );
}
