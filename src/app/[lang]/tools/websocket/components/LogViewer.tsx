...
export function LogViewer({ lang, logs, onClear }: LogViewerProps) {
  ...
  const getTypeStyles = (type: LogEntry["type"]) => {
    switch (type) {
      ...
      case "sent":
        return { badge: "bg-cyan-500/20 text-cyan-400", text: "text-cyan-300" };
      case "received":
        return {
  ...
  const getMessageTypeIcon = (msgType: MessageType) => {
    switch (msgType) {
      ...
      case "binary":
        return <Binary className="w-3 h-3 text-purple-400" />;
      default:
        return null;
    }
  };
              ...
              >
                <div className="flex gap-3">
                  ...
                  <div className="flex-grow min-w-0">
                    ...
                    {/* Message */}
                    <div
                      className={`text-xs break-all leading-relaxed ${styles.text} ${
