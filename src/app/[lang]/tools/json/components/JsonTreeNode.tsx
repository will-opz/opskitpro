...
export function JsonTreeNode({
  ...
  if (!isExpandable) {
    ...
    return (
      <div
        className="flex items-baseline py-[2px] hover:bg-zinc-50 rounded transition-colors"
    ...
    <div>
      ...
      >
        ...
        {!open && (
          <>
            ...
            <span className="text-[10px] text-zinc-300 ml-2 font-mono">
      ...
      {open && (
        <>
          ...
          <div
            className="text-zinc-400 font-mono py-[2px]"
            style={{ paddingLeft: indent + 24 }}
          >
            {bracket[1]}
          </div>
