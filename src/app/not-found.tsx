...
export default function NotFound() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-[#fafafa] font-sans gap-6 px-4">
      <div className="text-7xl sm:text-8xl font-black text-zinc-100 tracking-tighter select-none">
        404
      </div>
      <div className="text-center">
        <p className="text-zinc-900 font-semibold text-lg mb-1 tracking-tight">
          Page not found
        </p>
