...
export function SiteFooter({ dict }: { dict: any }) {
  return (
    <footer className="w-full border-t border-zinc-100 bg-white/75 backdrop-blur-xl z-10 mt-auto">
      <div className="max-w-6xl mx-auto px-6 py-5 flex flex-col md:flex-row justify-between items-center gap-4">
        ...
        <div className="flex items-center gap-3 bg-white/80 px-4 py-2 rounded-full border border-zinc-100 shadow-sm hover:border-emerald-500/30 transition-colors cursor-help">
